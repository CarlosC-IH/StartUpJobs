                ...
                <div class="col-lg-9 col-md-8">
                    <div class="mx-646">
                        ...
                        <h2 class="lg:tw-mb-10 tw-mb-6 {{ $setting->nav_color ? '' : $setting->nav_color }}">
                            Empowering Your Career Journey</h2>
                        <p class="body-font-2 text-gray-500 rt-mb-0">
                            At StartUpLab, we're more than just a job portal; we're your partner in career success. Our dedicated team is committed to revolutionizing the job search experience.<br />

                            <br />We believe in connecting talent with opportunity, ensuring that every individual finds meaningful work, and every employer discovers exceptional talent. With a passion for excellence, we strive to make the job market accessible, transparent, and rewarding for all. Join us on this journey as we shape the future of employment.
                        </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <h3 class="lg:tw-mb-8 tw-mb-4">Connecting Talent with Opportunity</h3>
