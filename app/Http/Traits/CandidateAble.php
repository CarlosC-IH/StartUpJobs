...
trait CandidateAble
{
    private function getCandidates($request)
    {
        ...
        if ($request->has('experience') && $request->experience != null && $request->experience != 'all') {
            $experience_id = Experience::whereHas('translations', function($query) use ($request) {
                $query->where('name', $request->experience);
            })->value('id');
        ...
        if ($request->has('education') && $request->education != null && $request->education != 'all') {
            $education_id = Education::whereHas('translations', function($query) use ($request) {
